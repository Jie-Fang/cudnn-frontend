...
class ResidualBlockDevPtrStore {
    ...
    public:
        ...
        auto
        setBNEpsilons(std::vector<std::pair<ResidualBlockParams::ForwardLocation, float>> const& epsilons) -> ResidualBlockDevPtrStore& {
        ...
        auto
        setBNExponentialAverageFactors(std::vector<std::pair<ResidualBlockParams::ForwardLocation, float>> const& exp_avg_factors) -> ResidualBlockDevPtrStore& {
        ...
        finalize() {
            ...
            XDescaleDevPtrs[ResidualBlockParams::ForwardLocation::RESIDUAL] = XDescaleDevPtrs[ResidualBlockParams::ForwardLocation::ZERO];
    ...
    private:
        ...
        setErrorAndThrowException(cudnnStatus_t status, const std::string& message) {
            ...
            logErrorMessage(status, "Residual Block Dev Ptr Store", "device pointer store", "residual block dev ptr store", errorMessage, message);

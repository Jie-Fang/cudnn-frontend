...
def test_scale_bias_relu_wgrad():
    ...
    graph = pycudnn.pygraph("sbr-wgrad", io_data_type = pycudnn.data_type.HALF, intermediate_data_type = pycudnn.data_type.FLOAT, compute_data_type = pycudnn.data_type.FLOAT)

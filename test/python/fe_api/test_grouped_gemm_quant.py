...
This module tests the contiguous grouped block-scaled GEMM with output quantization
for MoE (Mixture of Experts) workloads. Used for FC2 (forward down-projection)
and dFC1 (backward FC1 GEMMs).
"""

...
@pytest.mark.L0
def test_sdpa_fp8_fwd_thd_L0(env_info, test_no, request, cudnn_handle):
...
def test_sdpa_mxfp8_fwd_L0(env_info, test_no, request, cudnn_handle):
    ...
    with RandomizationContext(
        ...
        s_q_s_kv=RandomSequenceLength(s_q_min=128, s_q_max=128, s_kv_min=128, s_kv_max=128, s_q_distribution={"s_q=1": 0, "s_q=s_kv": 1, "s_q=random": 0}),

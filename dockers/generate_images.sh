...
docker image build --no-cache -t gitlab-master.nvidia.com:5005/cudnn/cudnn_frontend:cudnn_12.6.2 -f dockers/Dockerfile --build-arg CUDA_VERSION=12.6.2 --build-arg SKIP_CUDNN=true --build-arg DLFW_MONTH=24e.10 .
